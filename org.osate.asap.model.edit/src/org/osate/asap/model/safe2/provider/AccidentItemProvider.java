...
/**
 * This is the item provider adapter for a {@link org.osate.asap.model.safe2.Accident} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AccidentItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addAccidentlevelPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Accidentlevel feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAccidentlevelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Accident_accidentlevel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Accident_accidentlevel_feature", "_UI_Accident_type"),
				 Safe2Package.Literals.ACCIDENT__ACCIDENTLEVEL,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addHazardPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Accident_hazard_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Accident_hazard_feature", "_UI_Accident_type"),
				 Safe2Package.Literals.ACCIDENT__HAZARD,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Safe2Package.Literals.ACCIDENT__HAZARD);
		}
