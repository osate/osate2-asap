...
public class UCAHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (object == null) {
			Dialog.showInfo("ASAP Unsafe Control Actions Representation", "Please choose an instance model");
		...
		SiriusUtil.INSTANCE.autoOpenModel(systemInstance, ResourceUtil.getFile(systemInstance.eResource()).getProject(),
				"viewpoint:/org.osate.asap.view/Hazard Analyst", "TopLevelErrors", "ASAP: UCA Handler");
